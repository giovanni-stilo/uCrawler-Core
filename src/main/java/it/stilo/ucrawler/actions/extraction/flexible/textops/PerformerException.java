 ...
 * @author stilo
 */
public class PerformerException extends ExtractionException {
	private static final long serialVersionUID = 3843785440235299L;
	...
	public PerformerException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
